...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowBnbBalance, onDismiss }) => {
  ...
  const { balance: cakeBalance, fetchStatus: cakeFetchStatus } = useTokenBalance(tokens.coval.address)
  ...
  return (
    <>
      ...
      <Flex alignItems="center" justifyContent="end" mb="24px">
        <LinkExternal href={getBscScanLink(account, 'address')}>{t('View on EthScan')}</LinkExternal>
      </Flex>

...
export const mainnetTokens = defineTokens({
  ...
  coval: new Token(MAINNET, '0x3d658390460295fb963f54dc0899cfb1c30776df', 18, 'COVAL', 'Circuits of Value'),
} as const)

export const testnetTokens = defineTokens({
  weth: new Token(RINKEBY, '0xc778417e063141139fce010982780140aa0cd5ab', 18, 'WETH', 'Wrapped Ether'),
  coval: new Token(RINKEBY, '0x83dd89b40636f946a08975e97aa7a36d12dae551', 18, 'COVAL', 'Circuits of Value'),
} as const)
